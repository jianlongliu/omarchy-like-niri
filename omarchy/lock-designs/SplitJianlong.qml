// Copy of the Split design, with the account name shown as "Jianlong Liu"
// instead of the login name. Edit it here or with:
//   omarchy-shell lock editDesign my-splitjianlong
import QtQuick
